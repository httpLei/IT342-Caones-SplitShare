  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(135deg, #3b0764 0%, #662498 60%, #a855f7 100%)" }}>
      <nav className="flex items-center gap-8 px-10 py-5">
        <Link to="/login" className="text-xs font-bold tracking-widest uppercase opacity-50 hover:opacity-100 transition" style={{ color: "#C9BEFF" }}>
          Sign In
        </Link>
        <Link to="/register" className="text-xs font-bold tracking-widest uppercase" style={{ color: "#FFDBFD" }}>
          Sign Up
        </Link>
      </nav>
      ...
      <div className="flex flex-1 max-w-5xl mx-auto w-full">
        <div className="hidden md:flex flex-col justify-center items-start px-20 w-[50%]">
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center mb-8" style={{ background: "rgba(255,219,253,0.15)" }}>
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
              <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" stroke="#FFDBFD" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        ...
        <div className="flex flex-1 items-center justify-center p-6 md:p-8">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-10">
            ...
            {apiError && <div className="text-sm rounded-lg px-4 py-3 mb-5" style={{ background: "#FFDBFD", color: "#662498", border: "1px solid #e9b8f5" }}>{apiError}</div>}
