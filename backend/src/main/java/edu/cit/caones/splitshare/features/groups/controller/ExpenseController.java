...
public class ExpenseController {
    ...
    public ResponseEntity<ApiResponse<ExpenseDto>> getExpense(@PathVariable Long expenseId, Authentication authentication) {
    ...
    public ResponseEntity<ApiResponse<String>> deleteExpense(@PathVariable Long expenseId, Authentication authentication) {
