...
import edu.cit.caones.splitshare.shared.service.ReceiptStorageService;
...
public class ExpenseService {
    ...
    private ExpenseDto toExpenseDto(Expense expense, String currentUserEmail) {
        ...
        String desc = isPayer ? "You added " + expense.getDescription() : expense.getPaidBy().getFirstname() + " added " + expense.getDescription();
